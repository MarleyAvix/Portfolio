...
export const e5Activities: E5Activity[] = [
  ...
  },
  {
    ...
    skills: [
      { name: "Participer à la valorisation de l’image de l’organisation sur les médias numériques en tenant compte du cadre juridique et des enjeux économiques", isValidated: true },
  ...
  },
  {
    ...
    skills: [
      { name: "Réaliser les tests d'intégration et d'acceptation d'un service", isValidated: true },
      { name: "Déployer un service", isValidated: false },
      { name: "Accompagner les utilisateurs dans la mise en place d'un nouveau service", isValidated: true }
    ],
    isValidated: true
  },
  {
    ...
    skills: [
      { name: "Mettre en place son environnement d'apprentissage personnel", isValidated: true },
      { name: "Mettre en œuvre des outils et stratégies de veille informationnelle", isValidated: true },
      { name: "Gérer son identité professionnelle", isValidated: true },
